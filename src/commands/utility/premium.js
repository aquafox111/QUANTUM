    ...
    async execute(client, message, args) {
        ...
        if (sub === 'activate') {
            ...
            if (isGuildActive && days > 0) {
                ...
                return createMsg('Already Active', `Server **${guildName}** already has **Feather Premium**! (Expires: ${expiry})`, true);
            }
        ...
        if (sub === 'add') {
            ...
            if (isUserActive && days > 0) {
                ...
                return createMsg('Already Active', `**${targetUser.username}** already has **Feather Premium**! (Expires: ${expiry})`, true);
            }
