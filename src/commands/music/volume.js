        ...
        try {
            ...
            const createResponse = (text, isError = false, isInfo = false) => {
                const container = new ContainerBuilder().addTextDisplayComponents(
                    new TextDisplayBuilder().setContent(`${isError ? '> <:wrong:1500917527918678147> ' : isInfo ? '> <:Black_Volume:1500931980014129225> Volume ' : '> <:check_black:1500924675511812208> '}${text}`)
                );
